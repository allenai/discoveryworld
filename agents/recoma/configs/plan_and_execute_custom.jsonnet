...
local variation = std.parseInt(std.extVar('VARIATION'));
local generator_params = import "default_greedy_generator.libsonnet";
{
    ...
    "search": {
        ...
        "stopping_conditions": [
            ...
            {"type": "max_llm_calls", "max_llm_calls": 10000}, // Not necessary; mainly there to catch any rogue usage
            {"type": "max_llm_cost", "max_llm_cost": 150.00}  // Not necessary; mainly there to catch any rogue usage
        ]
    },
    "reader": {
